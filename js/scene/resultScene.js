...
export default class ResultScene {
  ...
  drawEle() {
    ...
    this.restartSprite = new Sprite(this.btnImg, (750 - this.btnImg.width) / 2, resultSprite.y + resultSprite.height + 40,
      this.btnImg.width, this.btnImg.height);
    this.restartSprite.draw(this.ctx);

    this.rankImg = Sprite.getImage('result_rank');
    this.rankSprite = new Sprite(this.rankImg, (750 - this.rankImg.width) / 2, this.restartSprite.y + this.restartSprite.height + 40,
